...
Phase I — LSP bridge (landed):

- [x] JSON-RPC 2.0 stdio client with LSP framing: lazy servers, timeouts, crash propagation, notification handling.
...
Phase Q — observability core (landed):
